...
public static void main(String[] args) {
	...
	Question q1=new Question(1,"zzzz",op,"1",1);
	Question q2=new Question(2,"cccc",op,"2",1);
	Question q3=new Question(3,"bbbbb",op,"4",1);
	Question q4=new Question(4,"qqqqqq",op,"1",1);
	Question q5=new Question(5,"aaaaaaa",op,"3",40);
